    ...
    public partial class CreateForm : Form
    {
        ...
        private void CreateBtn_Click(object sender, EventArgs e)
        {
            if (
                ...
                try { Program.Enterprise.AddManager(UserNameTB.Text, PasswordTB.Text, ChackPasswordTB.Text, FirstNameTB.Text, LastNameTB.Text, EMBGTB.Text, FounderTransactionNumberTB.Text, salary); }
                catch (Exception ex) { MessageBox.Show(ex.Message, "Грешка", MessageBoxButtons.OK, MessageBoxIcon.Error); }
            }
