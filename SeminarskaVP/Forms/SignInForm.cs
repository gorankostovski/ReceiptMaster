...
namespace SeminarskaVP.Forms
{
    public partial class SignInForm : Form
    {
        ...
        {
            if (UserNameTB.Text == "") { UserNameEP.SetError(UserNameTB,"Мора да внесете корисничко име"); }
            ...
            foreach (Classes.Employee empl in Program.Enterprise.Employees)
            {
                ...
                if ((empl.UserName == UserNameTB.Text) && (empl.Password == PasswordTB.Text))
                {
                    ...
                    if (Program.Enterprise.SignedInEmployee.EmployeeType() == Classes.Employee.EmployeeTypeEnum.Manager) {
